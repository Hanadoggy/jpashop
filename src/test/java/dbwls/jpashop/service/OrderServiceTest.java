...
import dbwls.jpashop.domain.item.Book;
import dbwls.jpashop.domain.item.Item;
import dbwls.jpashop.exception.NotEnoughStockException;
...
class OrderServiceTest {
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        assertEquals(OrderStatus.CANCEL, getOrder.getStatus(), "주무 취소시 상태는 CANCEL 이다.");
        assertEquals(10, item.getStockQuantity(), "주문 취소시 재고가 복구되어야 한다.");
